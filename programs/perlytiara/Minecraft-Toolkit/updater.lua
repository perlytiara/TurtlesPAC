...
function main()
	...
	local url = "https://raw.githubusercontent.com/perlytiara/TurtlesPAC/main/programs/perlytiara/Minecraft-Toolkit/"
	for _, file in ipairs(oldFileList) do 					
		clear()
		updated = updated + process(url, file, tmpDir, fileSizes)		-- download files from Github to tmp/
	end
	
	url = "https://raw.githubusercontent.com/perlytiara/TurtlesPAC/main/programs/perlytiara/Computercraft-GUI/"
	for _, file in ipairs(fileList) do 					
		clear()
		updated = updated + process(url, file, tmpDir, fileSizes)		-- download files from Github to tmp/
	end
